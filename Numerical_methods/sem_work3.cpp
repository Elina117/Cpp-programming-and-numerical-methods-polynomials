...
//Прописываем p, q, u и их происзводные функции
double p(double x)
{
...
//проверяет, больше ли каждый элемент вектора заданного значения
...
public:
  ...
  const Vector& getSolutions() override
  {
    ...
    std::cout << "Колличество итераций: " << k << '\n';
    return y;
  }
};
